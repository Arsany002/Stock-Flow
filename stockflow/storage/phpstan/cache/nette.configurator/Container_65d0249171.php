...
class Container_65d0249171 extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0459(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			$this->getService('041'),
			['#Call to an undefined method Laratrust\\\Models\\\.*#'],
			true
		);
	}
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_65d0249171 $container)
			{
	...
	public function createServiceContainer(): Container_65d0249171
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'ignoreErrors' => ['#Call to an undefined method Laratrust\\\Models\\\.*#'],
