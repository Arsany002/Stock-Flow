...
class Container_ed617590fa extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_ed617590fa $container)
			{
	...
	public function createServiceContainer(): Container_ed617590fa
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'generateBaselineFile' => '/var/www/html/phpstan-baseline.neon',
			'usedLevel' => '5',
